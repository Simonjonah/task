            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <form action="{{ url('admin/createprojects') }}" method="post" enctype="multipart/form-data">
                    @csrf
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      @enderror value="" id="exampleInputEmail1" placeholder="Project Name"> 
                    </div>
                    @error('project_name')
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    @enderror placeholder="Project Description"> </textarea>
                  </div>
                  @error('body')
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
