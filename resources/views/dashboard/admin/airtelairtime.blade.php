  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Airtel Airtime</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Airtel Airtime </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  @enderror value="airtel" id="exampleInputEmail1" placeholder="serviceID"> 
                </div>
                @error('serviceID')
                <span class="text-danger">{{ $message }}</span>
                @enderror
